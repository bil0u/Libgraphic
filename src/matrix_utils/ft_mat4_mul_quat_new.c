...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_mat4_mul_quat_new.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: upopee <upopee@student.42.fr>              +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/04/11 04:43:54 by upopee            #+#    #+#             */
/*   Updated: 2017/04/15 20:13:16 by upopee           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_quater	*ft_mat4_mul_quat_new(t_matrix4 *m, t_quater *v)
{
	t_quater		*dst;

	if (!(dst = (t_quater *)malloc(sizeof(t_quater))))
		return (NULL);
